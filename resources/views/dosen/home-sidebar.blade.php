<div class="sidebar-menu">
    ...
    <li class="list-none sidebar-item {{ Route::is('dosen.home-index') ? 'active' : '' }}">
        <a href="{{ route('dosen.home-index') }}"
            class='sidebar-link flex items-center px-4 py-3 text-gray-600 hover:bg-green-50 hover:border-l-3 hover:border-green-600 hover:text-green-700 transition-all duration-200 {{ Route::is('dosen.home-index') ? 'bg-green-50 border-l-3 border-green-600 text-green-700 font-semibold' : '' }}'>
            <i class="fa-solid fa-home w-5 text-center mr-3"></i>
            <span>Home</span>
        </a>
    </li>
    <li class="list-none sidebar-item {{ Route::is('dosen.home-profile*') ? 'active' : '' }}">
        <a href="{{ route('dosen.home-profile') }}"
            class='sidebar-link flex items-center px-4 py-3 text-gray-600 hover:bg-green-50 hover:border-l-3 hover:border-green-600 hover:text-green-700 transition-all duration-200 {{ Route::is('dosen.home-profile*') ? 'bg-green-50 border-l-3 border-green-600 text-green-700 font-semibold' : '' }}'>
    ...
    <li class="list-none sidebar-item {{ Route::is('dosen.akademik.jadwal-*') ? 'active' : '' }}">
        <a href="{{ route('dosen.akademik.jadwal-index') }}"
            class='sidebar-link flex items-center px-4 py-3 text-gray-600 hover:bg-green-50 hover:border-l-3 hover:border-green-600 hover:text-green-700 transition-all duration-200 {{ Route::is('dosen.akademik.jadwal-*') ? 'bg-green-50 border-l-3 border-green-600 text-green-700 font-semibold' : '' }}'>
    ...
    <li class="list-none sidebar-item {{ Route::is('dosen.akademik.stask-*') ? 'active' : '' }}">
        <a href="{{ route('dosen.akademik.stask-index') }}"
            class='sidebar-link flex items-center px-4 py-3 text-gray-600 hover:bg-green-50 hover:border-l-3 hover:border-green-600 hover:text-green-700 transition-all duration-200 {{ Route::is('dosen.akademik.stask-*') ? 'bg-green-50 border-l-3 border-green-600 text-green-700 font-semibold' : '' }}'>
