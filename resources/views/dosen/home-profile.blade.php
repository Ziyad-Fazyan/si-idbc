                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" name="dsn_name" id="dsn_name" class="form-control"
                                            ...
                                            value="{{ Auth::guard('dosen')->user()->dsn_name }}">
                                        @error('dsn_name')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" name="dsn_nidn" id="dsn_nidn" class="form-control"
                                            placeholder="Nomor NIM..." value="{{ Auth::guard('dosen')->user()->dsn_nidn }}">
                                        @error('dsn_nidn')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <select name="dsn_gend" id="dsn_gend" class="form-select">
                                            ...
                                            <option value="L"
                                                {{ Auth::guard('dosen')->user()->dsn_gend === 'L' ? 'selected' : '' }}>Laki
                                                Laki</option>
                                            <option value="P"
                                                {{ Auth::guard('dosen')->user()->dsn_gend === 'P' ? 'selected' : '' }}>
                                                Perempuan</option>
                                        </select>
                                        @error('dsn_gend')
                                            <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" name="dsn_birthplace" id="dsn_birthplace" class="form-control"
                                            placeholder="Tempat Lahir..."
                                            value="{{ Auth::guard('dosen')->user()->dsn_birthplace }}">
                                    ...
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="date" name="dsn_birthdate" id="dsn_birthdate"
                                            ...
                                            value="{{ Auth::guard('dosen')->user()->dsn_birthdate }}">
                                        @error('dsn_birthdate')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="dsn_phone" id="dsn_phone"
                                            value="{{ Auth::guard('dosen')->user()->dsn_phone }}">
                                        @error('dsn_phone')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                            ...
                            <form action="{{ route('dosen.home-profile-save-password') }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <input type="password" class="form-control" name="dsn_code" id="SecurityKey"
                                                value="{{ Auth::guard('dosen')->user()->dsn_code }}" disabled>
