                ...
                <form action="{{ route('dosen.akademik.stask-update', $task->code) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="bg-[#0C6E71] px-6 py-4 flex justify-between items-center">
                        ...
                        <div class="flex space-x-2">
                            <button type="submit" class="bg-[#FF6B35] hover:bg-orange-600 text-white px-4 py-2 rounded-md flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-8.707l-3-3a1 1 0 00-1.414 0l-3 3a1 1 0 001.414 1.414L9 9.414V13a1 1 0 102 0V9.414l1.293 1.293a1 1 0 001.414-1.414z" clip-rule="evenodd" />
                                </svg>
                                Kirim
                            </button>
                            <a href="@yield('urlmenu')" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-md flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="jadkul_id" id="jadkul_id" class="w-full rounded-md border-gray-300 shadow-sm focus:border-[#0C6E71] focus:ring focus:ring-[#0C6E71] focus:ring-opacity-50">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-[#2E2E2E] uppercase tracking-wider">Mata Kuliah</th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-[#2E2E2E] uppercase tracking-wider">Kelas</th>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            ...
                                            <form id="delete-form-{{ $item->code }}" action="{{ route('dosen.akademik.stask-destroy', $item->code) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" onclick="confirmDelete('{{ $item->code }}', '{{ $item->title }}')" 
