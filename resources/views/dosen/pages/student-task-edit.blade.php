                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title d-flex justify-content-between align-items-center">
                                ...
                                <div class="">
                                    <button type="submit" class="btn mt-1 btn-primary"><i
                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group col-lg-12 col-12">
                                ...
                                <input type="text" id="title" name="title" class="form-control"
                                    value="{{ $task->title }}" placeholder="Masukkan nama judul tugas...">
                                @error('title')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group col-lg-12 col-12">
                                ...
                                <textarea name="detail_task" id="summernote" cols="30" rows="10" class="form-control"
                            ...
                            <tbody>
                                @foreach ($stask as $key => $item)
                                    <tr>
                                        ...
                                        <td data-label="Nama Mata Kuliah">{{ $item->jadkul->matkul->name }} <br>
                                            {{ $item->jadkul->pert_id }}</td>
                                        ...
                                        <td class="d-flex justify-content-center align-items-center">
                                            <a href="{{ route('dosen.akademik.stask-edit', $item->code) }}"
                                                style="margin-right: 10px" class="btn btn-primary"><i
