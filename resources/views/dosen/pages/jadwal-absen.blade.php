                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($absen as $key => $item)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    {{ $item->absen_type === 'Hadir'
                                        ? 'bg-green-100 text-green-800'
                                        : ($item->absen_type === 'Izin'
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                        <button onclick="openModal('updateAbsen{{ $item->code }}')"
                                            class="text-[#0C6E71] hover:text-teal-700 mr-3">
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button type="button"
                        class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-[#FF6B35] text-base font-medium text-white hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 sm:ml-3 sm:w-auto sm:text-sm">
                        Simpan
                    </button>
