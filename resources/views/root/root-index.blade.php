                                ...
                                <div class="carousel-item active">
                                    <a href="{{ route('root.gallery-show', $item->slug) }}">
                                        ...
                                        <img src="{{ asset('storage/' . $item->cover) }}"
                                            style="height: 375px; width: 100%; object-fit: cover;" class="d-block w-100"
                                            alt="...">
                        ...
                        @foreach ($posts as $key => $item)
                            <div class="berita row">
                                <div class="col-lg-2 text-center">
                                    <img src="{{ asset('storage/images/' . $item->image) }}" style="" class="rounded"
                                        alt="">
                                </div>
                                <div class="col-lg-10">
                                    <a href="{{ route('root.post-view', $item->slug) }}"
                                        style="font-size: 20px; font-weight: 800;">{{ $item->name }}</a>
                                    <p class="mb-2">{{ Str::limit(strip_tags($item->content), 180) }}</p>
                                    <div class="d-flex justify-content-between align-items-center">

                                        <small>{{ $item->created_at->translatedFormat('l, d F Y - H.i') }} WIB <br> Author
                                            By <a href="#">{{ $item->author->name }}</a> - Kategori <a
                                                href="">{{ $item->category->name }}</a></small>
                                        <a href="{{ route('root.post-view', $item->slug) }}" class="btn btn-xs btn-info"><i
                ...
                <div class="card-body">
                    <div class="list-group list-group-horizontal-sm mb-1 text-center" role="tablist">
                        <a class="list-group-item list-group-item-action active" id="list-terbaru-list"
                            data-bs-toggle="list" href="#list-terbaru" role="tab">Daftar Pengumuman</a>
                        <a class="list-group-item list-group-item-action" id="list-terpopular-list" data-bs-toggle="list"
                            href="#list-terpopular" role="tab">Berita Terpopuler</a>
                    </div>
                    <div class="tab-content text-justify" style="text-align: justify">
                        <div class="tab-pane fade show active" id="list-terbaru" role="tabpanel"
                            aria-labelledby="list-terbaru-list">
                            <h6 class="text-center mt-2 mb-2">Pengumuman - {{ \Carbon\Carbon::now()->format('d M Y') }}
                            </h6>
