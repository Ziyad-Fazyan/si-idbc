                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-1">
                                ...
                                <select id="mhs_gend" name="mhs_gend" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('mhs_gend') border-red-500 @enderror">
                            ...
                            <div class="space-y-1">
                                ...
                                <select id="mhs_reli" name="mhs_reli" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('mhs_reli') border-red-500 @enderror">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="hidden" id="provinsi_name" name="mhs_addr_provinsi_name" value="{{ old('provinsi_name') }}">
                            @error('provinsi')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="hidden" id="kabupaten_name" name="mhs_addr_kota_name" value="{{ old('kabupaten_name') }}">
                            @error('kabupaten')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="hidden" id="kecamatan_name" name="mhs_addr_kecamatan_name" value="{{ old('kecamatan_name') }}">
                            @error('kecamatan')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="hidden" id="kelurahan_name" name="mhs_addr_kelurahan_name" value="{{ old('kelurahan_name') }}">
                            @error('kelurahan')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const loadWilayah = async (url, selectElement, placeholder) => {
        try {
    ...
    loadWilayah(`${API_BASE_URL}/provinces.json`, provinsiSelect, 'Provinsi')
        .then(success => {
