    ...
    <div class="breadcrumb-wrap-style-2"
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('root.home-download') }}">Document</a>
                </li>
            </ol>
        </nav>
                ...
                <div class="card-body row">
                    @forelse ($docs as $item)
                        <div class="form-group col-lg-12">
                            <p data-slug="{{ asset('storage/' . $item->path) }}" class="clickable"><img
                                    src="{{ asset('storage/' . $item->cover) }}"
                                    style="max-width: 50px; border-radius: 10px;" alt=""> {{ $item->name }}</p>
                        </div>
                    @empty
