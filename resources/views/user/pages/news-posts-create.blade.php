                    ...
                    <div class="card-body row">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="form-group">
                                <img src="{{ asset('storage/images/' . Auth::user()->image) }}" class="card-img-top"
                                    alt="">
                        ...
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="name"
                                    placeholder="Inputkan judul postingan...">
                                @error('name')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="keywords" id="keywords"
                                    placeholder="Inputkan kata kunci postingan...">
                                @error('keywords')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="metadesc" id="metadesc"
                                    placeholder="Inputkan meta deskripsi postingan...">
                                @error('metadesc')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
