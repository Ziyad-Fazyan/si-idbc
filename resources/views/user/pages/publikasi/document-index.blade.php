...
@section('content')
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <img src="{{ asset('storage/' . $item->cover) }}" 
                                                 class="mx-auto h-12 w-auto object-cover rounded" 
                                                 alt="{{ $item->name }}">
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $item->author->name }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $item->created_at->diffForHumans() }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <div class="flex justify-center items-center space-x-2">
                                                <button type="button" 
                                                        onclick="openDocumentModal('{{ $item->code }}')"
    ...
    <div id="deleteModal" class="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center hidden z-50">
        <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
            ...
            <div class="p-6">
                <p class="text-gray-700">Are you sure you want to delete document: <span id="deleteDocumentName" class="font-semibold"></span>?</p>
