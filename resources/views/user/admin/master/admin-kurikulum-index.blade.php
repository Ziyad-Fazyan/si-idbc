                    ...
                    <div class="card-body row">
                        <div class="form-group col-12">
                            ...
                            <input type="text" class="form-control" name="name" id="name"
                                placeholder="Inputkan nama kurikulum...">
                            @error('name')
                        ...
                        <div class="form-group col-12">
                            ...
                            <input type="text" class="form-control" name="code" id="code"
                                placeholder="Inputkan kode kurikulum..." maxlength="3" uppercase
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="number" class="form-control" name="year_start" id="year_start" min="2010"
                                max="2100" maxlength="4" value="{{ \Carbon\Carbon::now()->format('Y') }}"
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="number" class="form-control" name="year_ended" id="year_ended" min="2010"
                                max="2100" maxlength="4" value="{{ \Carbon\Carbon::now()->format('Y') }}"
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center align-items-center">
                                        <a href="#" style="margin-right: 10px" data-bs-toggle="modal"
                                            data-bs-target="#updateKurikulum{{ $item->code }}"
    ...
    <div class="me-1 mb-1 d-inline-block">
        ...
        @foreach ($kurikulum as $item)
            <form action="{{ route($prefix . 'master.kurikulum-update', $item->code) }}" method="POST"
                ...
                @method('patch')
                @csrf
                <div class="modal fade text-left w-100" id="updateKurikulum{{ $item->code }}" tabindex="-1"
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="form-group col-12">
                                        <label for="name">Nama Kurikulum</label>
                                        <input type="text" class="form-control" name="name" id="name"
                                            placeholder="Inputkan nama kurikulum..." value="{{ $item->name }}">
                                        @error('name')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group col-12">
                                        <label for="code">Kode Kurikulum ( 3 Huruf Kapital )</label>
                                        <input type="text" class="form-control" name="code" id="code"
                                            placeholder="Inputkan kode kurikulum..." value="{{ $item->code }}"
                                            maxlength="3" uppercase onkeydown="return /[a-zA-Z0-9]/i.test(event.key)">
                                        @error('code')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-6">
                                        <label for="year_ended">Pilih Tahun Akhir Berlaku</label>
                                        <input type="number" class="form-control" name="year_ended" id="year_ended"
                                            min="2010" max="2100" maxlength="4"
