                ...
                <div class="p-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-[#0C6E71]"
                                name="capacity" id="capacity" placeholder="Inputkan kapasitas Kelas..." max="35"
                                maxlength="2">
                            @error('capacity')
                                <small class="text-red-500">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="proku_id" id="proku_id"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-[#0C6E71]">
                    ...
                    <div class="p-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-[#0C6E71]"
                                    name="code" id="code" placeholder="Inputkan kode Kelas..."
                                    value="{{ $item->code }}" maxlength="32">
                                @error('code')
                                    <small class="text-red-500">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="space-y-2">
                                <label for="capacity" class="block text-sm font-medium text-gray-700">Kapasitas
                                    Kelas</label>
                                <input type="number"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-[#0C6E71]"
                                    name="capacity" id="capacity" placeholder="Inputkan kapasitas Kelas..."
                                    value="{{ $item->capacity }}" max="35" maxlength="2">
                                @error('capacity')
                                    <small class="text-red-500">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="space-y-2">
                                <label for="proku_id" class="block text-sm font-medium text-gray-700">Program
                                    Kuliah</label>
                                <select name="proku_id" id="proku_id"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-[#0C6E71]">
                                    <option value="" selected>Pilih Program Kuliah</option>
