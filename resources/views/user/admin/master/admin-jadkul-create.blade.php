            ...
            <form action="{{ route($prefix . 'master.jadkul-store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="">
                            <a href="{{ route($prefix . 'master.jadkul-index') }}" class="mt-1 btn btn-outline-warning"><i
                                    class="fa-solid fa-backward"></i></a>
                            <button type="submit" class="mt-1 btn btn-outline-primary"><i
                    ...
                    <div class="card-body row">
                        ...
                        <div class="form-group col-lg-3 col-12">
                            ...
                            <input type="number" min="1" max="8" name="bsks" id="bsks"
                                class="form-control" placeholder="Inputkan jumlah beban sks...">
                            @error('bsks')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-lg-3 col-12">
                            ...
                            <input type="time" name="ended" id="ended" class="form-control"
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title d-flex justify-content-between align-items-center">
                        @yield('submenu0')
                        <div class="">
                            <a href="{{ route($prefix . 'master.jadkul-create') }}" class="btn btn-outline-primary"><i
                        ...
                        <tbody>
                            @foreach ($jadkul as $key => $item)
                                <tr>
                                    ...
                                    <td data-label="Program Studi">{{ $item->kelas->pstudi->fakultas->name }} <br>
                                    ...
                                    <td data-label="Tanggal Kuliah">{{ $item->days_id }} <br> - <br>
                                        {{ \Carbon\Carbon::parse($item->date)->format('d M Y') }}</td>
                                    <td data-label="Waktu Perkuliahan">{{ $item->start }} <br> - <br>
                                        {{ $item->ended }}</td>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="myModalLabel16">Edit Jadwal Perkuliahan -
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-4 col-12">
                                        <label for="ruang_id">Ruangan</label>
                                        <select name="ruang_id" id="ruang_id" class="form-select" name="ruang_id"
                                            id="ruang_id">
                                            <option value="" selected>Pilih Ruangan</option>
                                            @foreach ($ruang as $item_r)
