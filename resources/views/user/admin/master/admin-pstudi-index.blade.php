...
@section('content')
                    ...
                    <div class="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-4 space-y-4">
                            <div class="space-y-2">
                                ...
                                <select name="faku_id" id="faku_id" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-[#0C6E71]">
                            ...
                            <div class="space-y-2">
                                <label for="code" class="block text-sm font-medium text-gray-700">Kode Program Studi ( 2 Angka )</label>
                                <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-[#0C6E71]" 
                                    name="code" id="code" placeholder="Inputkan kode program studi..." maxlength="2" uppercase 
                            ...
                            <div class="space-y-2">
                                <label for="cnim" class="block text-sm font-medium text-gray-700">Kode Awal NIM ( 5 Angka )</label>
                                <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-[#0C6E71]" 
                                    name="cnim" id="cnim" placeholder="Inputkan kode awal NIM program studi..." maxlength="5" uppercase 
                            ...
                            <div class="space-y-2">
                                <label for="title" class="block text-sm font-medium text-gray-700">Gelar Program Studi</label>
                                <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-[#0C6E71]" 
                            ...
                            <div class="space-y-2">
                                <label for="level" class="block text-sm font-medium text-gray-700">Jenjang Program Studi</label>
                                <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-[#0C6E71]" 
                            ...
                            <div class="space-y-2">
                                <label for="head_id" class="block text-sm font-medium text-gray-700">Kepala Program Studi</label>
                                <select name="head_id" id="head_id" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-[#0C6E71]">
                            ...
                            <table class="min-w-full divide-y divide-gray-200" id="table1">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Nama Program Studi</th>
                                        <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Kode Program Studi</th>
                                        <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Gelar Program Studi</th>
                                        <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Kepala Program Studi</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($pstudi as $key => $item)
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-4 py-3 text-center text-sm text-gray-500">{{ $item->fakultas->code . '-' . $item->code }}</td>
                                            <td class="px-4 py-3 text-center text-sm text-gray-500">{{ $item->level }} - ( {{ $item->title }} )</td>
                                            <td class="px-4 py-3 text-center text-sm text-gray-500">{{ $item->head->dsn_name }}</td>
    ...
    @foreach ($pstudi as $item)
        <div id="updatePStudi{{ $item->code }}" class="fixed inset-0 z-50 hidden overflow-auto bg-black bg-opacity-50 flex items-center justify-center p-4">
                ...
                <form action="{{ route($prefix . 'master.pstudi-update', $item->code) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-4 space-y-4">
                        <div class="space-y-2">
                            ...
                            <select name="faku_id" id="faku_id" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-[#0C6E71]">
                                ...
                                @foreach ($fakultas as $faku)
                                    <option value="{{ $faku->id }}" {{ $item->faku_id == $faku->id ? 'selected' : '' }}>
                                        {{ $faku->name }}</option>
                                @endforeach
                            </select>
                            @error('faku_id')
                        ...
                        <div class="space-y-2">
                            <label for="name" class="block text-sm font-medium text-gray-700">Nama Program Studi</label>
                            <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-[#0C6E71]" 
                                name="name" id="name" placeholder="Inputkan nama program studi..." value="{{ $item->name }}">
                            @error('name')
                                <small class="text-red-500">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="space-y-2">
                            <label for="code" class="block text-sm font-medium text-gray-700">Kode Program Studi ( 2 Angka )</label>
                            <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-[#0C6E71]" 
                                name="code" id="code" placeholder="Inputkan kode program studi..." value="{{ $item->code }}" 
                        ...
                        <div class="space-y-2">
                            <label for="cnim" class="block text-sm font-medium text-gray-700">Kode Awal NIM ( 5 Angka )</label>
                            <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-[#0C6E71]" 
                                name="cnim" id="cnim" placeholder="Inputkan kode awal NIM program studi..." value="{{ $item->cnim }}" 
                        ...
                        <div class="space-y-2">
                            <label for="title" class="block text-sm font-medium text-gray-700">Gelar Program Studi</label>
                            <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-[#0C6E71]" 
                                name="title" id="title" placeholder="Inputkan gelar program studi..." value="{{ $item->title }}" uppercase>
                            @error('title')
                                <small class="text-red-500">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="space-y-2">
                            <label for="level" class="block text-sm font-medium text-gray-700">Jenjang Program Studi</label>
                            <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-[#0C6E71]" 
                                name="level" id="level" placeholder="Inputkan jenjang program studi..." value="{{ $item->level }}" uppercase>
                            @error('level')
                                <small class="text-red-500">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="space-y-2">
                            ...
                            <select name="head_id" id="head_id" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-[#0C6E71]">
                                ...
                                @foreach ($dosen as $dsn)
                                    <option value="{{ $dsn->id }}" {{ $item->head_id == $dsn->id ? 'selected' : '' }}>
                                        {{ $dsn->dsn_name }}</option>
                                @endforeach
                            </select>
                            @error('head_id')
