                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="name"
                                placeholder="Inputkan nama program studi...">
                            @error('name')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="code" id="code"
                                placeholder="Inputkan kode program studi..." maxlength="2" uppercase
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="cnim" id="cnim"
                                placeholder="Inputkan kode awal NIM program studi..." maxlength="5" uppercase
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" id="title"
                                placeholder="Inputkan gelar program studi..." uppercase>
                            @error('title')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="level" id="level"
                                placeholder="Inputkan jenjang program studi..." uppercase>
                            @error('level')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <tbody>
                            @foreach ($pstudi as $key => $item)
                                <tr>
                                    ...
                                    <td data-label="Kode Program Studi">{{ $item->fakultas->code . '-' . $item->code }}
                                    </td>
                                    <td data-label="Gelar Program Studi">{{ $item->level }} - ( {{ $item->title }} )
                                    </td>
                                    <td data-label="Kepala Program Studi">{{ $item->head->dsn_name }}</td>
                                    <td class="d-flex justify-content-center align-items-center">
                                        <a href="#" style="margin-right: 10px" data-bs-toggle="modal"
                                            data-bs-target="#updatePStudi{{ $item->code }}"
    ...
    <div class="me-1 mb-1 d-inline-block">
        ...
        @foreach ($pstudi as $item)
            <form action="{{ route($prefix . 'master.pstudi-update', $item->code) }}" method="POST"
                ...
                @method('patch')
                @csrf
                <div class="modal fade text-left w-100" id="updatePStudi{{ $item->code }}" tabindex="-1"
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label for="name">Nama Program Studi</label>
                                        <input type="text" class="form-control" name="name" id="name"
                                            placeholder="Inputkan nama program studi..." value="{{ $item->name }}">
                                        @error('name')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        <label for="code">Kode Program Studi ( 2 Angka )</label>
                                        <input type="text" class="form-control" name="code" id="code"
                                            placeholder="Inputkan kode program studi..." value="{{ $item->code }}"
                                    ...
                                    <div class="form-group">
                                        <label for="cnim">Kode Awal NIM ( 5 Angka )</label>
                                        <input type="text" class="form-control" name="cnim" id="cnim"
                                            placeholder="Inputkan kode awal NIM program studi..."
                                    ...
                                    <div class="form-group">
                                        <label for="title">Gelar Program Studi</label>
                                        <input type="text" class="form-control" name="title" id="title"
                                            placeholder="Inputkan gelar program studi..." value="{{ $item->title }}"
                                            uppercase>
                                        @error('title')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        <label for="level">Jenjang Program Studi</label>
                                        <input type="text" class="form-control" name="level" id="level"
                                            placeholder="Inputkan jenjang program studi..." value="{{ $item->level }}"
                                            uppercase>
                                        @error('level')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
