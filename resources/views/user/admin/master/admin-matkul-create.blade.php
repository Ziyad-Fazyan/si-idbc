                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="">
                            ...
                            <a href="{{ route($prefix . 'master.matkul-index') }}" class="btn btn-outline-warning"><i
                    ...
                    <div class="card-body row">
                        ...
                        <div class="form-group col-lg-3 col-12">
                            ...
                            <input type="number" min="10" max="40" name="bsks" id="bsks"
                                class="form-control" placeholder="Inputkan beban sks matakuliah...">
                            @error('bsks')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-lg-4 col-12">
                            ...
                            <select name="taka_id" id="taka_id" class="form-select" name="taka_id" id="taka_id">
                                ...
                                @foreach ($taka as $item_t)
                                    <option value="{{ $item_t->id }}">{{ $item_t->name . ' - ' . $item_t->semester }}
                                    </option>
                                @endforeach
                            </select>
                            @error('taka_id')
