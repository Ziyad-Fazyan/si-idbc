...
@section('content')
    <section class="w-full p-4">
        ...
        <div class="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
            ...
            <div class="flex items-center justify-between p-4 border-b border-gray-200">
                ...
                <div>
                    {{-- Tombol Tambah Data Tahun Akademik, menggunakan x-data dan open-modal dari Alpine.js --}}
                    <button type="button" x-data @click="$dispatch('open-modal', {name: 'create-taka'})"
                        ...
                        aria-label="Tambah data tahun akademik baru"> {{-- Perbaiki aria-label --}}
                        <i class="fa-solid fa-plus"></i>
                    </button>
                </div>
            </div>

            {{-- Isi Tabel Daftar Tahun Akademik --}}
            <div class="p-4">
    ...
    @include('user.admin.master.modal.taka-edit')
    
    <x-modal name="create-taka">
        @include('user.admin.master.modal.taka-create')
    </x-modal>
@endsection
{{-- @section('custom-js') diganti menjadi @push('scripts') untuk konsistensi --}}
@push('scripts')
    <script>
        // Modal functions
