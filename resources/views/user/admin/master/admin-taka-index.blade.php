                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="name"
                                placeholder="Inputkan nama tahun akademik...">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="code" id="code"
                                placeholder="Inputkan kode tahun akademik..." maxlength="6" uppercase
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="semester" id="semester"
                                placeholder="Inputkan kode tahun akademik...">
                            @error('semester')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="year_start" id="year_start" min="2000"
                                max="2100" maxlength="4" value="{{ \Carbon\Carbon::now()->format('Y') }}"
                                placeholder="Inputkan tahun masuk...">
                            @error('year_start')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center align-items-center">
                                        <a href="#" style="margin-right: 10px" data-bs-toggle="modal"
                                            data-bs-target="#updateTaka{{ $item->code }}"
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="form-group">
                                        <label for="name">Nama Tahun Akademik</label>
                                        <input type="text" class="form-control" name="name" id="name"
                                            value="{{ $item->name }}" placeholder="Inputkan nama tahun akademik...">
                                        @error('name')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        <label for="code">Kode Fakultas ( 6 Angka )</label>
                                        <input type="text" class="form-control" name="code" id="code"
                                            placeholder="Inputkan kode tahun akademik..." value="{{ $item->code }}"
                                    ...
                                    <div class="form-group">
                                        <label for="semester">Semester Perkuliahan</label>
                                        <input type="text" class="form-control" name="semester" id="semester"
                                            placeholder="Inputkan kode tahun akademik..." value="{{ $item->semester }}">
                                        @error('semester')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
