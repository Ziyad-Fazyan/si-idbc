                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="name"
                                placeholder="Inputkan nama Program Kuliah...">
                            @error('name')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="code" id="code"
                                placeholder="Inputkan kode Program Kuliah..." maxlength="20" uppercase>
                            @error('code')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="wave" id="wave"
                                placeholder="Inputkan Gelombang Program Kuliah..." maxlength="20" uppercase>
                            @error('wave')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="wave_start" id="wave_start"
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="wave_ended" id="wave_ended"
                        ...
                        <tbody>
                            @foreach ($proku as $key => $item)
                                <tr>
                                    ...
                                    <td data-label="Periode Pendaftaran">
    ...
    <div class="me-1 mb-1 d-inline-block">
        ...
        @foreach ($proku as $item)
            <form action="{{ route($prefix . 'master.proku-update', $item->code) }}" method="POST"
                ...
                @method('patch')
                @csrf
                <div class="modal fade text-left w-100" id="updateProku{{ $item->code }}" tabindex="-1"
                    role="dialog" aria-labelledby="myModalLabel16" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-l" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="myModalLabel16">Edit Program Kuliah - {{ $item->name }}
                                </h4>
                                <div class="">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <select name="taka_id" id="taka_id" class="form-select">
                                            ...
                                            @foreach ($taka as $tk)
                                                <option value="{{ $tk->id }}"
                                                    {{ $item->taka_id == $tk->id ? 'selected' : '' }}>{{ $tk->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('taka_id')
                                    ...
                                    <div class="form-group">
                                        <label for="name">Nama Program Kuliah</label>
                                        <input type="text" class="form-control" name="name" id="name"
                                            placeholder="Inputkan nama Program Kuliah..." value="{{ $item->name }}">
                                        @error('name')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
