        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title d-flex justify-content-between align-items-center">
                    @yield('submenu')
                    <div class="">
                        <a href="{{ route($prefix . 'master.jadkul-index') }}" class="btn btn-outline-warning mt-1"><i
                                class="fa-solid fa-backward"></i></a>
                        <a href="#" style="margin-right: 10px" data-bs-toggle="modal" data-bs-target="#cetakDataAbsen"
                            class="btn btn-outline-danger mt-1"><i class="fa-solid fa-file-pdf"></i></a>
                    </div>
                </h5>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($absen as $key => $item)
                            <tr>
                                ...
                                <td data-label="Waktu Absen">{{ \Carbon\Carbon::parse($item->absen_time)->format('H:i') }}
                                    WIB</td>
                                <td class="d-flex justify-content-center align-items-center">
                                    <a href="#" style="margin-right: 10px" data-bs-toggle="modal"
                                        data-bs-target="#updateAbsen{{ $item->code }}" class="btn btn-outline-primary"><i
        ...
        <form action="{{ route($prefix . 'master.jadkul-absen-cetak', $jadkul->code) }}" method="POST"
            ...
            <div class="modal fade text-left w-100" id="cetakDataAbsen" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-l" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel16">Cetak Data Absensi -
                                ...
                                <div class="form-group col-lg-12 col-12">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <button type="submit" class="btn btn-outline-danger"
                                            style="margin-left: 10px"><i class="fa-solid fa-file-pdf"></i></button>
                                    </div>
