                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="#"><img src="{{ asset('storage/images/' . $web->school_logo) }}"
                                    class="card-img-top" alt="Logo Kampus"></a>
                            <hr>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group col-lg-12 col-12">
                                ...
                                <input type="text" name="school_apps" id="school_apps" class="form-control"
                            ...
                            <div class="form-group col-lg-12 col-12">
                                ...
                                <textarea name="school_desc" id="dark" class="form-control" cols="30" rows="10"
                                    placeholder="Inputkan pesan sambutan...">{{ $web->school_desc }}</textarea>
                                @error('school_desc')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group col-lg-12 col-12">
                                ...
                                <input type="text" name="school_link" id="school_link" class="form-control"
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="form-group d-flex justify-content-between align-items-center">
                                ...
                                <div class="" style="margin-left: 5px">
                                    <button class="btn btn-warning" id="syncButton"><i
                        ...
                        <div class="col-lg-6 col-12">
                            <form action="{{ route('web-admin.system.database-import') }}" method="POST"
                                ...
                                <div class="form-group d-flex justify-content-between align-items-center">
                                    ...
                                    <button type="submit" class="btn btn-primary" style="margin-left: 5px;"><i
                                            class="fa-solid fa-upload"></i></button>
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#databaseReset"
                                        style="margin-left: 5px;" class="btn btn-danger"><i
                                            class="fa-solid fa-sync"></i></a>
                                    <div class="" style="margin-left: 5px">
                                        <a href="{{ route('web-admin.system.database-export') }}"
                                            class="btn btn-success"><i class="fa-solid fa-download"></i></a>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-l" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <span class="text-center"><b>Peringatan !!!</b> Aksi ini akan mereset semua database anda.
                                    <br>Silahkan inputkan <b>Secret Key</b> untuk melanjutkan</span>
                ...
                fetch('{{ route('web-admin.system.website-check') }}', {
                    ...
                    .then(data => {
                        ...
                        if (data.message.includes('There is an update available')) {
                            ...
                            alertDiv.innerHTML =
                                `${data.message} <a href="#" id="updateNow">Update Now</a>`;
