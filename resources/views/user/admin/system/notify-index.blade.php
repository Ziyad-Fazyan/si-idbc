                ...
                <form action="{{ route($prefix . 'system.notify-store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="desc" id="dark" class="form-control" cols="30" rows="10"
                                placeholder="Inputkan pesan notifikasi"></textarea>
                            @error('desc')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                                ...
                                <tr class="">
                                    ...
                                    <td class="d-flex justify-content-center align-items-center">
                                        <a href="#" style="margin-right: 10px" data-bs-toggle="modal"
                                            data-bs-target="#updateNotify{{ $item->code }}"
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label for="desc">Pesan Notifikasi</label>
                                        <textarea name="desc" id="dark" class="form-control" cols="30" rows="10"
                                            placeholder="Inputkan pesan notifikasi">{!! $item->desc !!}</textarea>
                                        @error('desc')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
