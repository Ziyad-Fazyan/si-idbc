        ...
        <div class="bg-white rounded-lg shadow-md">
            <form action="{{ route($prefix . 'system.notify-store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex justify-between items-center px-6 py-4 border-b border-gray-200">
                    ...
                    <button type="submit" class="bg-[#0C6E71] hover:bg-[#095254] text-white px-3 py-2 rounded-md transition duration-300">
                ...
                <div class="p-6">
                    ...
                    <div class="mb-4">
                        <label for="absen_type" class="block text-sm font-medium text-gray-700 mb-1">Target Notifikasi</label>
                    ...
                    <div class="mb-4">
                        <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Judul Notifikasi</label>
                        <input type="text" name="name" id="name" class="w-full rounded-md border-gray-300 shadow-sm focus:border-[#0C6E71] focus:ring focus:ring-[#0C6E71] focus:ring-opacity-50"
                    ...
                    <div class="mb-4">
                        <label for="type" class="block text-sm font-medium text-gray-700 mb-1">Kategori Notifikasi</label>
                        <input type="text" name="type" id="type" class="w-full rounded-md border-gray-300 shadow-sm focus:border-[#0C6E71] focus:ring focus:ring-[#0C6E71] focus:ring-opacity-50"
                    ...
                    <div class="mb-4">
                        <label for="desc" class="block text-sm font-medium text-gray-700 mb-1">Pesan Notifikasi</label>
                        <textarea name="desc" id="dark" class="w-full rounded-md border-gray-300 shadow-sm focus:border-[#0C6E71] focus:ring focus:ring-[#0C6E71] focus:ring-opacity-50"
                ...
                <table class="min-w-full divide-y divide-gray-200" id="notifyTable">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Judul Notifikasi</th>
                            <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Kategori</th>
                            <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Author</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 flex justify-center items-center space-x-2">
                                <button type="button" class="px-2 py-1 border border-[#0C6E71] text-[#0C6E71] hover:bg-[#0C6E71] hover:text-white rounded-md transition duration-300"
                                ...
                                <form id="delete-form-{{ $item->code }}"
                                    ...
                                    @csrf
                                    @method('DELETE')
                                    <button type="button" class="px-2 py-1 border border-red-500 text-red-500 hover:bg-red-500 hover:text-white rounded-md transition duration-300"
            ...
            <form action="{{ route($prefix . 'system.notify-update', $item->code) }}" method="POST"
                ...
                <div class="flex justify-between items-center px-6 py-4 border-b border-gray-200">
                    ...
                    <div class="flex space-x-2">
                        <button type="submit" class="px-2 py-1 border border-[#0C6E71] text-[#0C6E71] hover:bg-[#0C6E71] hover:text-white rounded-md transition duration-300">
                ...
                <div class="p-6">
                    <div class="mb-4">
                        <label for="edit-name-{{ $item->code }}" class="block text-sm font-medium text-gray-700 mb-1">Judul Notifikasi</label>
                        <input type="text" class="w-full rounded-md border-gray-300 shadow-sm focus:border-[#0C6E71] focus:ring focus:ring-[#0C6E71] focus:ring-opacity-50"
                            name="name" id="edit-name-{{ $item->code }}" placeholder="Inputkan nama fakultas..." value="{{ $item->name }}">
                        @error('name')
                        <small class="text-red-500">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="mb-4">
                        <label for="edit-type-{{ $item->code }}" class="block text-sm font-medium text-gray-700 mb-1">Kategori</label>
                        <input type="text" class="w-full rounded-md border-gray-300 shadow-sm focus:border-[#0C6E71] focus:ring focus:ring-[#0C6E71] focus:ring-opacity-50"
                            name="type" id="edit-type-{{ $item->code }}" placeholder="Inputkan kode fakultas..." value="{{ $item->type }}">
                        @error('type')
                        <small class="text-red-500">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="mb-4">
                        <label for="edit-desc-{{ $item->code }}" class="block text-sm font-medium text-gray-700 mb-1">Pesan Notifikasi</label>
                        <textarea name="desc" id="edit-desc-{{ $item->code }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-[#0C6E71] focus:ring focus:ring-[#0C6E71] focus:ring-opacity-50"
