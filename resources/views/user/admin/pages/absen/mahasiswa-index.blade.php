...
@endsection
@section('subdesc')
    Halaman untuk mengelola data absensi mahasiswa
@endsection
...
<div class="p-6">
    ...
    <section class="mb-8">
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div class="p-4">
                <form action="{{ route($prefix . 'absensi.mahasiswa.index') }}" method="GET">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div class="flex items-end space-x-2">
                            ...
                            <a href="{{ route($prefix . 'absensi.mahasiswa.index') }}" class="px-4 py-2 bg-gray-200 text-gray-800 rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        <a href="{{ route($prefix . 'absensi.mahasiswa.show', $item->id) }}" class="text-blue-600 hover:text-blue-900">
                                        ...
                                        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                            <div class="relative bg-white rounded-lg shadow">
                                                ...
                                                <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200">
                                                    ...
                                                    <form action="{{ route($prefix . 'absensi.mahasiswa.destroy', $item->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
