...
<div class="p-6">
    <div class="mb-8">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center">
            <div class="mb-4 md:mb-0">
                <h3 class="text-2xl font-bold text-gray-800">Kelola Absensi Dosen</h3>
                <p class="text-gray-600">Manajemen data absensi dosen</p>
            </div>
            <div>
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Absensi Dosen</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                ...
                <form action="{{ route($prefix . 'dosen.index') }}" method="GET">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                            ...
                            <select class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" name="dosen_id" id="dosen_id">
                                <option value="">Semua Dosen</option>
                                @foreach($dosen as $d)
                                <option value="{{ $d->id }}" {{ request('dosen_id') == $d->id ? 'selected' : '' }}>{{ $d->dsn_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
    ...
    <section>
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="p-4 border-b border-gray-200">
                <h4 class="text-lg font-semibold text-gray-800">Daftar Absensi Dosen</h4>
            </div>
            <div class="p-4">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $item->mata_kuliah }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    ...
                                    @else
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800">Unknown</span>
                                    @endif
                                </td>
                                        ...
                                        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                            <div class="relative bg-white rounded-lg shadow">
                                                ...
                                                <div class="p-6 space-y-6">
                                                    <p class="text-gray-700">Apakah Anda yakin ingin menghapus data absensi dosen ini?</p>
                                                </div>
                            ...
                            @empty
                            <tr>
                                <td colspan="7" class="px-6 py-4 text-center text-sm text-gray-500">Tidak ada data absensi dosen</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
