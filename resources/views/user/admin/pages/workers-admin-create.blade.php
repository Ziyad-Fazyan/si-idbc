            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100">
                    <div class="bg-[#0C6E71] px-4 py-3 flex justify-between items-center">
                        ...
                        <a href="{{ route('web-admin.workers.admin-index') }}" class="text-white hover:text-gray-200">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="reli" id="reli"
                                        ...
                                        <option value="2" {{ old('reli') == '2' ? 'selected' : '' }}>Agama Kristen
                                            Protestan</option>
                                        <option value="3" {{ old('reli') == '3' ? 'selected' : '' }}>Agama Kriten
                                            Katholik</option>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="mb-4">
                                    ...
                                    <select name="type" id="type"
                                        ...
                                        <option value="1" {{ old('type') == '1' ? 'selected' : '' }}>Staff Finance
                                        </option>
                                        <option value="2" {{ old('type') == '2' ? 'selected' : '' }}>Absen</option>
                                        <option value="3" {{ old('type') == '3' ? 'selected' : '' }}>Staff Akademik
                                        </option>
                                        <option value="4" {{ old('type') == '4' ? 'selected' : '' }}>Staff Musyrif
                                        </option>
                                        <option value="5" {{ old('type') == '5' ? 'selected' : '' }}>Staff Sarana dan
                                            Prasarana</option>
                                        <option value="6" {{ old('type') == '6' ? 'selected' : '' }}>Staff Site
                                            Manager</option>
                                    </select>
                                    @error('type')
                                        <small class="text-red-500 text-xs">{{ $message }}</small>
