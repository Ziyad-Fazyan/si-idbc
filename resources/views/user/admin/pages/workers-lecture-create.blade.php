...
@endsection
@section('content')
    <form action="{{ route($prefix . 'workers.lecture-store') }}" method="POST" enctype="multipart/form-data"
        id="multiStepForm">
        @csrf
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100">
                    <div class="bg-[#0C6E71] px-4 py-3 flex justify-between items-center">
                        ...
                        <a href="{{ route($prefix . 'workers.lecture-index') }}" class="text-white hover:text-gray-200">
                    ...
                    <div class="p-4">
                        ...
                        <div>
                            <label for="dsn_image" class="block text-sm font-medium text-gray-700 mb-2">Upload Foto
                                Profil</label>
                            <input type="file"
                                ...
                                name="dsn_image" id="dsn_image" accept="image/*" required>
                            @error('dsn_image')
                    ...
                    <div class="border-b border-gray-200">
                        <ul class="flex" id="myTab" role="tablist">
                            ...
                            <li class="flex-1" role="presentation">
                                <button
                                    class="w-full py-3 border-b-2 border-transparent text-gray-500 font-medium disabled-tab"
                                    id="profile-tab" data-tab-target="#profile" type="button" role="tab" disabled>
                                    Akun
                                </button>
                            </li>
                        </ul>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="date" name="dsn_birthdate" id="dsn_birthdate"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#0C6E71]"
                                        value="{{ old('dsn_birthdate') }}" required>
                                    @error('dsn_birthdate')
                                        <small class="text-red-500 text-xs">{{ $message }}</small>
                                    @enderror
                                </div>
                        ...
                        <div class="tab-pane hidden" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="mb-4">
                                    ...
                                    <input type="text"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#0C6E71]"
                                        name="dsn_phone" id="dsn_phone" placeholder="Nomor telepon..."
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="email"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#0C6E71]"
                                        name="dsn_mail" id="dsn_mail" placeholder="Alamat email..."
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="mb-4">
                                    ...
                                    <select name="dsn_stat" id="dsn_stat"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#0C6E71]"
                                        required>
                                        <option value="0" {{ old('dsn_stat') == '0' ? 'selected' : '' }}>Non-Active
                                        </option>
                                        <option value="1" {{ old('dsn_stat') == '1' ? 'selected' : '' }}>Active
                                        </option>
                                    </select>
                                    @error('dsn_stat')
                                        <small class="text-red-500 text-xs">{{ $message }}</small>
