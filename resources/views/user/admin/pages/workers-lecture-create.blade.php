        ...
        <section class="section row">
            <div class="col-lg-4 col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="{{ asset('storage/images/default/default-profile.jpg') }}" class="card-img-top"
                            alt="">
                        <hr>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="#home" role="tab"
                                    aria-controls="home" aria-selected="true"><i class="fa-solid fa-id-card"
                                        style="margin-right: 5px"></i> Data Personal</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="contact-tab" data-bs-toggle="tab" href="#contact" role="tab"
                                    aria-controls="contact" aria-selected="false"><i class="fa-solid fa-address-book"
                                        style="margin-right: 5px"></i> Data Kontak</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#profile" role="tab"
                                    aria-controls="profile" aria-selected="false"><i class="fa-solid fa-user-lock"
                                        style="margin-right: 5px;"></i> Pengaturan Akun</a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" name="dsn_name" id="dsn_name" class="form-control"
                                    ...
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" name="dsn_nidn" id="dsn_nidn" class="form-control"
                                    ...
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" name="dsn_user" id="dsn_user" class="form-control"
                                            placeholder="Username...">
                                        @error('dsn_user')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                            ...
                            <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="dsn_phone" id="dsn_phone"
                                    ...
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="dsn_mail" id="dsn_mail"
