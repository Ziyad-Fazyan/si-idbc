                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="phone" id="phone"
                                            placeholder="Inputkan nomor telepon..." value="{{ $admin->phone }}">
                                        @error('phone')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="email" id="email"
                                            placeholder="Inputkan alamat email..." value="{{ $admin->email }}">
                                        @error('email')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="contact_name_1"
                                            id="contact_name_1" placeholder="Inputkan nomor telepon..."
                                    ...
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="contact_phone_1"
                                            id="contact_phone_1" placeholder="Inputkan nomor telepon..."
                                    ...
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="contact_name_2"
                                            id="contact_name_2" placeholder="Inputkan nomor telepon..."
                                    ...
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="contact_phone_2"
                                            id="contact_phone_2" placeholder="Inputkan nomor telepon..."
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <input type="password" class="form-control" name="code" id="SecurityKey"
                                                value="{{ $admin->code }}" disabled>
