                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="px-6 py-4 flex items-center justify-between border-b">
                        ...
                        <div class="flex space-x-2">
                            <a href="@yield('urlmenu')"
                                class="border border-amber-500 text-amber-500 hover:bg-amber-500 hover:text-white transition duration-300 rounded px-3 py-2">
                                <i class="fa-solid fa-backward"></i>
                            </a>
                            <button type="submit"
                                class="border border-[#0C6E71] text-[#0C6E71] hover:bg-[#0C6E71] hover:text-white transition duration-300 rounded px-3 py-2">
                    ...
                    <div class="p-6">
                        <img src="{{ asset('storage/images/default/default-profile.jpg') }}"
                            class="w-full h-auto rounded-lg" alt="Profile Photo" id="preview-image">
                        <div class="border-t my-4"></div>
                        <div class="mb-4">
                            <label for="image" class="block text-gray-700 font-medium mb-2">Upload Foto Profile</label>
                            <div class="flex items-center">
                                <input type="file"
                                    class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0C6E71]"
                                    name="image" id="image">
                            </div>
                            @error('image')
                    ...
                    <div class="p-6">
                        ...
                        <div class="border-b">
                            <nav class="flex space-x-2" id="tab-navigation">
                                <button type="button"
                                    class="px-4 py-2 border-b-2 border-[#0C6E71] text-[#0C6E71] font-medium tab-button"
                                    data-tab="personal">
                                    Personal
                                </button>
                                ...
                                <button type="button" class="px-4 py-2 hover:text-[#0C6E71] tab-button"
                                    data-tab="security">
                                    Keamanan
                                </button>
                            </nav>
                        ...
                        <div class="py-4" id="tab-content">
                            ...
                            <div class="tab-pane" id="personal">
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                    ...
                                    <div class="mb-4">
                                        <label for="gend" class="block text-gray-700 font-medium mb-2">Jenis
                                            Kelamin</label>
                                        <select name="gend" id="gend"
                                            class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0C6E71] appearance-none bg-white">
                                    ...
                                    <div class="mb-4">
                                        <label for="birth_place" class="block text-gray-700 font-medium mb-2">Tempat
                                            Lahir</label>
                                    ...
                                    <div class="mb-4">
                                        <label for="birth_date" class="block text-gray-700 font-medium mb-2">Tanggal
                                            Lahir</label>
                            ...
                            <div class="tab-pane hidden" id="contact">
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                    ...
                                    <div class="mb-4">
                                        <label for="email" class="block text-gray-700 font-medium mb-2">Alamat
                                            Email</label>
                                        <input type="text"
                                            class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0C6E71]"
                                    ...
                                    <div class="mb-4">
                                        <label for="contact_name_1" class="block text-gray-700 font-medium mb-2">Nama
                                    ...
                                    <div class="mb-4">
                                        <label for="contact_phone_1" class="block text-gray-700 font-medium mb-2">Nomor
                                            Kontak Darurat 1</label>
                                        <input type="text"
                                            class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0C6E71]"
                                    ...
                                    <div class="mb-4">
                                        <label for="contact_name_2" class="block text-gray-700 font-medium mb-2">Nama
                                    ...
                                    <div class="mb-4">
                                        <label for="contact_phone_2" class="block text-gray-700 font-medium mb-2">Nomor
                                            Kontak Darurat 2</label>
                                        <input type="text"
                                            class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0C6E71]"
                            ...
                            <div class="tab-pane hidden" id="security">
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                    <div class="mb-4">
                                        <label for="type" class="block text-gray-700 font-medium mb-2">Type
                                            Users</label>
                                    ...
                                    <div class="mb-4">
                                        <label for="newPassword" class="block text-gray-700 font-medium mb-2">Password
                                            Baru</label>
                                        <div class="flex">
                                            <input type="password"
                                                class="w-full px-3 py-2 border rounded-l-lg focus:outline-none focus:ring-2 focus:ring-[#0C6E71]"
                                                name="password" id="newPassword" placeholder="Inputkan password...">
                                            <button type="button"
                                                class="px-3 py-2 bg-white border border-l-0 rounded-r-lg text-red-500 hover:bg-red-50 toggle-password"
                                    ...
                                    <div class="mb-4">
                                        <label for="newPasswordKonfirm"
                                            class="block text-gray-700 font-medium mb-2">Konfirmasi Password Baru</label>
                                        <div class="flex">
                                            <input type="password"
                                                class="w-full px-3 py-2 border rounded-l-lg focus:outline-none focus:ring-2 focus:ring-[#0C6E71]"
