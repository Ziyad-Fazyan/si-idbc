...
@section('title')
    Data Pengguna Karyawan - SIAKAD PT - Internal Developer
@endsection
@section('menu')
...
@endsection
@section('subdesc')
    Halaman untuk menambah data pengguna Karyawan
@endsection
@section('content')
    <form action="{{ route('web-admin.workers.staff-store') }}" method="POST" enctype="multipart/form-data" id="multiStepForm">
        @csrf
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100">
                    <div class="bg-[#0C6E71] px-4 py-3 flex justify-between items-center">
                        ...
                        <a href="{{ route($prefix . 'workers.staff-index') }}" class="text-white hover:text-gray-200">
                    ...
                    <div class="p-4">
                        ...
                        <div>
                            <label for="image" class="block text-sm font-medium text-gray-700 mb-2">Upload Foto
                                Profil</label>
                            <input type="file"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="gend" id="gend"
                                        ...
                                        <option value="P" {{ old('gend') == 'P' ? 'selected' : '' }}>Perempuan
                                        </option>
                                    </select>
                                    @error('gend')
                                        <small class="text-red-500 text-xs">{{ $message }}</small>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="reli" id="reli"
                                        ...
                                        <option value="1" {{ old('reli') == '1' ? 'selected' : '' }}>Agama Islam
                                        </option>
                                        <option value="2" {{ old('reli') == '2' ? 'selected' : '' }}>Agama Kristen
                                            Protestan</option>
                                        <option value="3" {{ old('reli') == '3' ? 'selected' : '' }}>Agama Kristen
                                            Katholik</option>
                                        <option value="4" {{ old('reli') == '4' ? 'selected' : '' }}>Agama Hindu
                                        </option>
                                        <option value="5" {{ old('reli') == '5' ? 'selected' : '' }}>Agama Buddha
                                        </option>
                                        <option value="6" {{ old('reli') == '6' ? 'selected' : '' }}>Agama Konghuchu
                                        </option>
                                    </select>
                                    @error('reli')
                                        <small class="text-red-500 text-xs">{{ $message }}</small>
                        ...
                        <div class="tab-pane hidden" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#0C6E71]"
                                        name="contact_name_1" id="contact_name_1" placeholder="Nama kontak darurat..."
                                        value="{{ old('contact_name_1') }}" required>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('contact_phone_1') }}" required>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#0C6E71]"
                                        name="contact_name_2" id="contact_name_2" placeholder="Nama kontak darurat..."
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="mb-4">
                                    ...
                                    <select name="type" id="type"
                                        ...
                                        <option value="0" {{ old('type') == '0' ? 'selected' : '' }}>Web
                                            Administrator</option>
                                        <option value="1" {{ old('type') == '1' ? 'selected' : '' }}>Departement
                                            Finance</option>
                                        <option value="2" {{ old('type') == '2' ? 'selected' : '' }}>Departement
                                            Absen</option>
                                        <option value="3" {{ old('type') == '3' ? 'selected' : '' }}>Departement
                                            Academic</option>
                                        <option value="4" {{ old('type') == '4' ? 'selected' : '' }}>Departement
                                            Mutabaah</option>
                                        <option value="5" {{ old('type') == '5' ? 'selected' : '' }}>Departement
                                            Support</option>
                                    </select>
                                    @error('type')
                                        <small class="text-red-500 text-xs">{{ $message }}</small>
