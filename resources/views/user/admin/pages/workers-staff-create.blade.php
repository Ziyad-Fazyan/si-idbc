                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="contact_name_1"
                                            id="contact_name_1" placeholder="Inputkan nama kontak darurat...">
                                    ...
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="contact_phone_1"
                                            id="contact_phone_1" placeholder="Inputkan nomor telepon kontak darurat...">
                                    ...
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="contact_name_2"
                                            id="contact_name_2" placeholder="Inputkan nama kontak darurat...">
                                    ...
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" class="form-control" name="contact_phone_2"
                                            id="contact_phone_2" placeholder="Inputkan nomor telepon kontak darurat...">
