                ...
                <h5 class="text-lg font-semibold flex justify-between items-center">
                    ...
                    <div class="flex space-x-2">
                        <a href="{{ route('web-admin.workers.admin-create') }}"
                            class="bg-[#0C6E71] text-white px-4 py-2 rounded hover:bg-teal-700 flex items-center">
                        ...
                        @foreach ($admin as $key => $item)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center flex justify-center space-x-2">
                                    <button onclick="openContactModal('{{ $item->code }}')"
                                        class="bg-blue-100 text-blue-600 p-2 rounded hover:bg-blue-200">
                                    ...
                                    <button onclick="confirmDelete('{{ $item->code }}', '{{ $item->name }}')"
    ...
    <div id="importModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
        <div class="bg-white rounded-lg w-full max-w-lg">
            <form action="{{ route('web-admin.services.convert.import-users') }}" method="POST"
                ...
                <div class="p-4">
                    <div class="mb-4">
                        <label for="import" class="block text-sm font-medium text-gray-700 mb-1">Import Files (xlsx,
                            csv)</label>
            ...
            <div class="bg-white rounded-lg w-full max-w-lg">
                ...
                <div class="p-4">
                    <div class="mb-4">
                        ...
                        <div class="flex">
                            <input type="text"
                                class="flex-1 px-3 py-2 border border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-[#0C6E71] focus:border-transparent"
                                value="{{ $item->phone }}" readonly>
                            <a href="https://wa.me/{{ $item->phone }}" target="_blank"
                                class="bg-green-500 text-white px-3 py-2 rounded-r-md hover:bg-green-600">
