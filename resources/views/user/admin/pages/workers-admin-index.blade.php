...
@section('content')
            ...
            <div class="p-6 border-b border-gray-100 bg-gray-50/50">
                <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <button type="button" x-data @click="$dispatch('open-modal', {name: 'export-users'})"
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse ($admin as $key => $item)
                            <tr class="hover:bg-gray-50/50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="inline-flex px-2.5 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                        {{ $item->type }}
                                    </span>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <div class="flex items-center justify-center space-x-2">
                                        ...
                                        <form action="{{ route('web-admin.workers.admin-destroy', $item->code) }}"
    ...
    <x-modal name="export-users">
        @include('user.admin.pages.modal.export-users')
    </x-modal>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Hide loading indicator after page loads or after AJAX requests
            window.addEventListener('load', hideLoading);
            window.addEventListener('pageshow', hideLoading);

            // Hide loading after modal interactions are complete
            ...
            // Listen for Alpine.js events if using Alpine
