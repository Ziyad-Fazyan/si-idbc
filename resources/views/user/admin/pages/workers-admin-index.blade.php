        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title d-flex justify-content-between align-items-center">
                    @yield('submenu')
                    <div class="">
                        <a href="{{ route('web-admin.workers.admin-create') }}" class="btn btn-outline-primary"><i
                                class="fa-solid fa-plus"></i></a>
                        <a href="{{ route('web-admin.services.convert.export-users') }}" class="btn btn-outline-success"><i
                                class="fa-solid fa-file-export"></i></a>
                        <a href="#" class="btn btn-outline-danger" data-bs-toggle="modal"
                            data-bs-target="#importUsers"><i class="fa-solid fa-file-import"></i></a>
                    </div>
                </h5>
            </div>
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-center align-items-center">
                                    ...
                                    <form id="delete-form-{{ $item->code }}"
                                        action="{{ route('web-admin.workers.admin-destroy', $item->code) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
