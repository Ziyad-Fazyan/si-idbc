                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="p-4">
                        <form action="{{ route('mahasiswa.home-profile-save-image') }}" method="POST"
                            ...
                            <img src="{{ asset('storage/images/' . $student->mhs_image) }}" class="w-full h-auto rounded-md"
                                id="profileImage" alt="Profile Photo">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex items-center">
                                    <input type="file"
                                        class="flex-1 border border-gray-300 rounded-md p-2 text-sm file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:bg-[#0C6E71] file:text-white hover:file:bg-[#0A5E61]"
                                        name="mhs_image" id="mhs_image">
                                    @error('mhs_image')
                                        <small class="text-red-500">{{ $message }}</small>
                                    @enderror
                                    <button type="submit"
                                        class="ml-2 px-3 py-2 border border-[#0C6E71] text-[#0C6E71] rounded hover:bg-[#0C6E71] hover:text-white transition-colors">
                                        <i class="fa-solid fa-paper-plane"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <ul class="flex flex-wrap -mb-px">
                                <li class="mr-2">
                                    <button @click="activeTab = 'personal'"
                                        :class="{ 'text-[#0C6E71] border-b-2 border-[#0C6E71]': activeTab === 'personal', 'text-gray-500 hover:text-gray-700': activeTab !== 'personal' }"
                                ...
                                <li class="mr-2">
                                    <button @click="activeTab = 'contact'"
                                        :class="{ 'text-[#0C6E71] border-b-2 border-[#0C6E71]': activeTab === 'contact', 'text-gray-500 hover:text-gray-700': activeTab !== 'contact' }"
                                        class="inline-block px-4 py-2 font-medium">
                                        Kontak
                                    </button>
                                </li>
                                <li class="mr-2">
                                    <button @click="activeTab = 'security'"
                                        :class="{ 'text-[#0C6E71] border-b-2 border-[#0C6E71]': activeTab === 'security', 'text-gray-500 hover:text-gray-700': activeTab !== 'security' }"
                                        class="inline-block px-4 py-2 font-medium">
                                        Keamanan
                                    </button>
                                </li>
                        ...
                        <div class="py-4" x-data="{ activeTab: 'personal' }">
                            ...
                            <div x-show="activeTab === 'personal'" class="space-y-4">
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label for="years_id" class="block text-sm font-medium text-gray-700 mb-1">Tahun
                                            Masuk</label>
                                    ...
                                    <div>
                                        ...
                                        <select name="mhs_gend" id="mhs_gend"
                                            class="w-full border border-gray-300 rounded-md p-2">
                                            <option value="" selected>Pilih Jenis Kelamin</option>
                                            <option value="L" {{ $student->mhs_gend === 'L' ? 'selected' : '' }}>Laki
                                                Laki</option>
                                    ...
                                    <div>
                                        ...
                                        <select name="mhs_reli" id="mhs_reli"
                                            ...
                                            <option value="1" {{ $student->raw_mhs_reli === '1' ? 'selected' : '' }}>
                                                Agama Islam</option>
                                            <option value="2" {{ $student->raw_mhs_reli === '2' ? 'selected' : '' }}>
                                                Agama Kristen Protestan</option>
                                            <option value="3" {{ $student->raw_mhs_reli === '3' ? 'selected' : '' }}>
                                                Agama Kriten Katholik</option>
                                            <option value="4" {{ $student->raw_mhs_reli === '4' ? 'selected' : '' }}>
                                                Agama Hindu</option>
                                            <option value="5" {{ $student->raw_mhs_reli === '5' ? 'selected' : '' }}>
                                                Agama Buddha</option>
                                            <option value="6" {{ $student->raw_mhs_reli === '6' ? 'selected' : '' }}>
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" class="w-full border border-gray-300 rounded-md p-2"
                                            name="mhs_phone" id="mhs_phone" value="{{ $student->mhs_phone }}">
                                        @error('mhs_phone')
                                            <small class="text-red-500">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div>
                                        ...
                                        <input type="text"
                                            class="w-full border border-gray-300 rounded-md p-2 bg-gray-100"
                                            name="mhs_mail" id="mhs_mail" readonly value="{{ $student->mhs_mail }}">
                                        @error('mhs_mail')
                                            <small class="text-red-500">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="lg:col-span-2">
                                        ...
                                        <textarea cols="15" rows="4" class="w-full border border-gray-300 rounded-md p-2"
                                            name="mhs_addr_domisili" id="mhs_addr_domisili" placeholder="alamat lengkap domisili / tempat tinggal...">{{ $student->mhs_addr_domisili == null ? '' : $student->mhs_addr_domisili }}</textarea>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="w-full border border-gray-300 rounded-md p-2"
                                            name="mhs_addr_kelurahan" id="mhs_addr_kelurahan"
                                            placeholder="nama kelurahan..." value="{{ $student->mhs_addr_kelurahan }}">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="w-full border border-gray-300 rounded-md p-2"
                                            name="mhs_addr_kecamatan" id="mhs_addr_kecamatan"
                                            placeholder="nama kecamatan..." value="{{ $student->mhs_addr_kecamatan }}">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="w-full border border-gray-300 rounded-md p-2"
                                            name="mhs_addr_provinsi" id="mhs_addr_provinsi"
                                            placeholder="nama provinsi..." value="{{ $student->mhs_addr_provinsi }}">
                            ...
                            <div x-show="activeTab === 'security'" class="space-y-4">
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <div class="flex items-center">
                                            <input type="password"
                                                class="flex-1 border border-gray-300 rounded-md p-2 bg-gray-100"
                                                name="mhs_code" id="SecurityKey" value="{{ $student->mhs_code }}"
                                                disabled>
                                            <button type="button"
                                                class="ml-2 px-3 py-2 border border-red-500 text-red-500 rounded hover:bg-red-500 hover:text-white transition-colors toggle-password"
                                    ...
                                    <div>
                                        ...
                                        <select name="mhs_stat" id="mhs_stat"
                                            ...
                                            <option value="0" {{ $student->raw_mhs_stat === 0 ? 'selected' : '' }}>
                                                Calon Mahasiswa</option>
                                            <option value="1" {{ $student->raw_mhs_stat === 1 ? 'selected' : '' }}>
                                                Mahasiswa Aktif</option>
                                            <option value="2" {{ $student->raw_mhs_stat === 2 ? 'selected' : '' }}>
                                                Mahasiswa Non-Aktif</option>
                                            <option value="3" {{ $student->raw_mhs_stat === 3 ? 'selected' : '' }}>
                                                Mahasiswa Alumni</option>
                                        </select>
                                        @error('old_password')
                                            <small class="text-red-500">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center">
                                            <input type="password" class="flex-1 border border-gray-300 rounded-md p-2"
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center">
                                            <input type="password" class="flex-1 border border-gray-300 rounded-md p-2"
                                                name="password_confirmed" id="newPasswordKonfirm">
                                            <button type="button"
                                                class="ml-2 px-3 py-2 border border-red-500 text-red-500 rounded hover:bg-red-500 hover:text-white transition-colors toggle-password"
