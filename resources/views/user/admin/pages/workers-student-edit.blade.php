            ...
            <div class="col-lg-4 col-12">
                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="">
                            <a href="@yield('urlmenu')" class="btn btn-outline-warning"><i
                    ...
                    <div class="card-body">
                        <form action="{{ route('mahasiswa.home-profile-save-image') }}" method="POST"
                            ...
                            <img src="{{ asset('storage/images/' . $student->mhs_image) }}" class="card-img-top"
                                alt="">
                            <hr>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#profile" role="tab"
                                    aria-controls="profile" aria-selected="false"> Keamanan</a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <input type="text" name="pstudi_id" id="pstudi_id" class="form-control"
                                            placeholder="Nama Program Studi..." readonly
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-12 col-12">
                                        ...
                                        <textarea cols="15" rows="4" class="form-control" name="mhs_addr_domisili" id="mhs_addr_domisili"
                                            placeholder="alamat lengkap domisili / tempat tinggal..." value="{{ $student->mhs_addr_domisili }}">{{ $student->mhs_addr_domisili == null ? '' : $student->mhs_addr_domisili }}</textarea>
