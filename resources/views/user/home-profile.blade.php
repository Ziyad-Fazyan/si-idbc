                                ...
                                <div class="row">
                                    ...
                                    <div class="d-flex justify-content-end align-items-center">
                                        <button type="submit" class="btn btn-outline-primary"><i
                                                style="margin-right: 5px" class="fa-solid fa-paper-plane"></i>
                                            Save</button>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <input type="password" class="form-control" name="old_password"
                                                id="oldPassword" placeholder="Inputkan password lama...">
                                            <span class="btn btn-sm btn-outline-danger" style="margin-left: 5px"
                                                id="showPasswordButton"><i class="fa-solid fa-eye"></i></span>
                                        </div>
                                        @error('old_password')
                                    ...
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <input type="password" class="form-control" name="new_password"
                                                id="newPassword" placeholder="Inputkan password baru...">
                                            <span class="btn btn-sm btn-outline-danger" style="margin-left: 5px"
                                                id="showPasswordButton"><i class="fa-solid fa-eye"></i></span>
                                        </div>
                                        @error('new_password')
                                    ...
                                    <div class="form-group col-lg-6 col-12">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <input type="password" class="form-control" name="new_password_confirmed"
                                                id="newPasswordKonfirm" placeholder="Konfirmasi password baru...">
                                            <span class="btn btn-sm btn-outline-danger" style="margin-left: 5px"
                                                id="showPasswordButton"><i class="fa-solid fa-eye"></i></span>
                                        </div>
