            ...
            <div class="card mb-2">
                ...
                <div class="card-body row">
                    <div class="form-group col-lg-4 col-12">
                        ...
                        <input type="text" name="mhs_name" id="mhs_name" class="form-control" readonly
                    ...
                    <div class="form-group col-lg-4 col-12">
                        ...
                        <input type="text" name="stat_id" id="stat_id" required class="form-control" readonly
                            value="{{ $ticket->stat_id }}">
            ...
            <div class="card-body">
                <div class="form-group row">
                    <div class="col-lg-3">
                        <div class="d-flex">
                            <div class="avatar avatar-lg me-3">
                                <img src="{{ asset('storage/images/' . $ticket->users->mhs_image) }}" class="avatar-sm"
                                    alt="">
                            </div>
