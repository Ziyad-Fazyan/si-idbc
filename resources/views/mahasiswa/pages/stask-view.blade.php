        ...
        <div class="card">
            ...
            <div class="card-body row">
                <div class="form-group col-lg-4 col-12">
                    ...
                    <input type="text" readonly id="exp_date" name="exp_date"
                        value="{{ $stask->jadkul->matkul->name }} - {{ $stask->jadkul->pert_id }}" class="form-control">
                    @error('exp_date')
                ...
                <div class="form-group col-lg-4 col-12">
                    ...
                    <input type="date" readonly id="exp_date" name="exp_date" value="{{ $stask->exp_date }}"
                        class="form-control">
                    @error('exp_date')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                ...
                <div class="form-group col-lg-4 col-12">
                    ...
                    <input type="time" readonly id="exp_time" name="exp_time" value="{{ $stask->exp_time }}"
                        class="form-control">
                    @error('exp_time')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                ...
                <div class="form-group col-lg-12 col-12">
                    ...
                    <input type="text" readonly id="title" name="title" class="form-control"
                        value="{{ $stask->title }}" placeholder="Masukkan nama judul tugas...">
                    @error('title')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="form-group col-lg-12 col-12">
                    ...
                    <textarea readonly name="detail_task" id="detail_task" cols="30" rows="10" class="form-control"
            ...
            <div class="card">
                ...
                <div class="card-body row">
                    <div class="form-group col-lg-4 col-12">
                        ...
                        <input type="file" readonly id="file_1" name="file_1" class="form-control"
                    ...
                    <div class="form-group col-lg-4 col-12">
                        ...
                        <input type="file" readonly id="file_2" name="file_2" class="form-control"
                            placeholder="Masukkan nama judul tugas...">
                        @error('file_2')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="form-group col-lg-4 col-12">
                        ...
                        <input type="file" readonly id="file_3" name="file_3" class="form-control"
                            placeholder="Masukkan nama judul tugas...">
                        @error('file_3')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
