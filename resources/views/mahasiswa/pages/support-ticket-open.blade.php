        ...
        <div class="card">
            ...
            <div class="card-body row">
                <div class="col-lg-6 col-6 text-center mb-4">
                    <a href="{{ route('mahasiswa.support.ticket-create', 1) }}" class="btn btn-warning">Departement
                        Finance</a>
                ...
                <div class="col-lg-6 col-6 text-center mb-4">
                    <a href="{{ route('mahasiswa.support.ticket-create', 3) }}" class="btn btn-primary">Departement
                        Akademik</a>
