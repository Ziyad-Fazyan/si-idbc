            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title d-flex justify-content-between align-items-center">
                        ...
                        <div class="">
                            ...
                            <a href="{{ route('mahasiswa.home-jadkul-index') }}" class="btn btn-outline-warning"><i
                ...
                <div class="card-body row">
                    <div class="form-group col-lg-4 col-12">
                        ...
                        <input type="file" name="absen_proof" id="absen_proof" class="form-control"
                            placeholder="inputkan bukti absensi...">
                        @error('absen_proof')
                    ...
                    <div class="form-group col-lg-4 col-12" style="display: none">
                        ...
                        <input type="text" name="jadkul_code" id="jadkul_code" value="{{ $jadkul->code }}" readonly
                            class="form-control" placeholder="inputkan kode jadwal kuliah...">
                        @error('jadkul_code')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="form-group col-lg-4 col-12">
                        ...
                        <input type="text" name="jadkul_name" id="jadkul_name"
                            value="{{ $jadkul->matkul->name . ' - ' . $jadkul->pert_id }}" readonly class="form-control"
                            placeholder="inputkan kode jadwal kuliah...">
                        @error('jadkul_name')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="form-group col-lg-4 col-12" style="display: none">
                        ...
                        <input type="text" name="author_id" id="author_id"
                            value="{{ Auth::guard('mahasiswa')->user()->id }}" readonly class="form-control"
                            placeholder="inputkan id mahasiswa...">
                        @error('author_id')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="form-group col-lg-4 col-12">
                        ...
                        <input type="text" name="author_name" id="author_name"
                            value="{{ Auth::guard('mahasiswa')->user()->mhs_name }}" readonly class="form-control"
                            placeholder="inputkan id mahasiswa...">
                        @error('author_name')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="form-group col-lg-3 col-12">
                        ...
                        <input type="text" name="author_class" id="author_class"
                            value="{{ Auth::guard('mahasiswa')->user()->kelas->name }}" readonly class="form-control"
                            placeholder="inputkan id mahasiswa...">
                        @error('author_class')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="form-group col-lg-3 col-12">
                        ...
                        <input type="date" name="absen_date" id="absen_date"
                            value="{{ \Carbon\Carbon::now()->toDateString() }}" readonly class="form-control"
                            placeholder="inputkan id mahasiswa...">
                        @error('absen_date')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
