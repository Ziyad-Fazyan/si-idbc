                    ...
                    <tbody>
                        @foreach ($stask as $key => $item)
                            <tr>
                                ...
                                <td data-label="Mata Kuliah">{{ $item->jadkul->matkul->name }} <br>
                                    {{ $item->jadkul->pert_id }}</td>
                                <td data-label="Nama Dosen">
                                    {{ \Carbon\Carbon::parse($item->exp_date)->isoFormat('dddd, D MMMM Y') }} <br>
                                    {{ \Carbon\Carbon::parse($item->exp_time)->format('H:i') }} WIB </td>
