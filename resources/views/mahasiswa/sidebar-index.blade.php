...
<li class="sidebar-item has-sub {{ Route::is('mahasiswa.support.*', request()->path()) ? 'active' : '' }}">
    ...
    <ul class="submenu">
        <li
            class="submenu-item {{ Route::is('mahasiswa.support.ticket-index', 'mahasiswa.support.ticket-view', request()->path()) ? 'active' : '' }}">
            <a href="{{ route('mahasiswa.support.ticket-index') }}" class="submenu-link">Lihat Ticket</a>
        </li>
        <li
            class="submenu-item {{ Route::is('mahasiswa.support.ticket-open', 'mahasiswa.support.ticket-create', request()->path()) ? 'active' : '' }}">
