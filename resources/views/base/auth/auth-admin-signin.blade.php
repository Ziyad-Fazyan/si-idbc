        ...
        <div class="max-w-6xl w-full grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div class="hidden lg:flex flex-col justify-center space-y-8">
                <div class="text-center lg:text-left">
                    <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-primary to-primary-light rounded-2xl shadow-xl mb-6">
                        <i class="fas fa-user-shield text-3xl text-white"></i>
                    </div>
                    <h1 class="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
                        Admin <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Portal</span>
                    </h1>
                    <p class="text-lg text-gray-600 leading-relaxed">
                        Kelola sistem pendidikan dengan mudah dan efisien. Akses dashboard administrator untuk mengelola data siswa, guru, dan sistem pembelajaran.
                    </p>
                </div>
                    ...
                    <div class="text-center mb-8">
                        <div class="flex justify-center mb-6">
                            <div class="relative">
                                ...
                                <div class="absolute -top-1 -right-1 w-6 h-6 bg-gradient-to-br from-primary to-secondary rounded-full flex items-center justify-center">
