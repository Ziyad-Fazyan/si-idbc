...
@section('content')
        ...
        <div class="max-w-6xl w-full grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div class="hidden lg:flex flex-col justify-center space-y-8">
                <div class="text-center lg:text-left">
                    <div
                        class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-primary to-primary-light rounded-2xl shadow-xl mb-6">
                        <i class="fas fa-user-shield text-3xl text-white"></i>
                    </div>
                    <h1 class="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
                        Admin <span
                            class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Portal</span>
                    </h1>
                    <p class="text-lg text-gray-600 leading-relaxed">
                        Kelola sistem pendidikan dengan mudah dan efisien. Akses dashboard administrator untuk mengelola
                        data siswa, guru, dan sistem pembelajaran.
                    </p>
                </div>
                    ...
                    <div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-gray-200/50 shadow-sm">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Laporan sistem</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-full max-w-md mx-auto lg:mx-0">
                <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 p-8">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <h2 class="text-2xl font-bold text-gray-900 mb-2">Admin Sign In</h2>
                    ...
                    <!-- Login Form -->
                    <form action="{{ route('admin.auth-signin-post') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="text" name="login" id="login"
                                    class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm"
                                    placeholder="Masukkan username, email atau nomor telepon" autocomplete="username">
                            </div>
                            @error('login')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="password" name="password" id="password"
                                    class="block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm"
                    ...
                    <div class="mt-8 text-center space-y-3">
                        ...
                        <a href="{{ route('root.home-index') }}"
                            class="inline-flex items-center text-sm text-gray-600 hover:text-primary transition-colors font-medium">
    ...
    @push('styles')
        <style>
            ...
            .form-input {
                @apply w-full pl-10 pr-4 py-3 bg-white/80 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 backdrop-blur-sm;
            }
            ...
            .form-checkbox {
                @apply w-4 h-4 text-primary bg-white border-2 border-gray-300 rounded focus:ring-primary/20 focus:ring-2 transition-all duration-200;
            }

            .btn-primary {
                @apply w-full bg-gradient-to-r from-primary to-primary-light hover:from-primary-light hover:to-primary text-white font-semibold py-3 px-6 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:ring-offset-2 shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-[1.02];
            }
