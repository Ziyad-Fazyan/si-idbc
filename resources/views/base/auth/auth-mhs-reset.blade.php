            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                        <img src="{{ asset('storage/images/' . $web->school_logo) }}" alt="ESEC Logo"
                        ...
                        <div class="card card-plain">
                            ...
                            <div class="card-body">
                                <form action="{{ route('mahasiswa.auth-reset-post', $token) }}" method="POST"
                                    role="form">
                                    @csrf

                                    <div class="mb-3">
                                        <input type="password" class="form-control form-control-lg" name="password"
                                            placeholder="Inputkan password baru..." aria-label="Email">
                                        @error('password')
                                    ...
                                    <div class="mb-3">
                                        <input type="password" class="form-control form-control-lg" name="password_confirm"
                                            placeholder="Konfirmasi password baru..." aria-label="Email">
                                        @error('password_confirm')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Reset
                                            Password</button>
                                    </div>
                                </form>
                            </div>
                            <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                <p class="mb-0 text-sm mx-auto">
                                    ...
                                    <a href="{{ route('mahasiswa.auth-signin-page') }}"
                                        class="text-primary text-gradient font-weight-bold">Login Here</a>
                                </p>
                                <p class="mb-0 text-sm mx-auto">
                                    Back to home?
                                    <a href="{{ route('root.home-index') }}"
                                        class="text-primary text-gradient font-weight-bold">Come Here</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                            ...
                            <p class="text-white position-relative">The more effortless the writing looks, the more effort
