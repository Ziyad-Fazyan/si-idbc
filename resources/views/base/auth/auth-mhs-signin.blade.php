                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-gray-200/50 shadow-sm">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="font-semibold text-gray-900">Course Access</p>
                                <p class="text-sm text-gray-600">Akses mata kuliah</p>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-gray-200/50 shadow-sm">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="font-semibold text-gray-900">Progress Track</p>
                                <p class="text-sm text-gray-600">Pantau kemajuan</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-full max-w-md mx-auto lg:mx-0">
                <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 p-8">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <p class="text-gray-600">Masuk ke portal pembelajaran Anda</p>
                    </div>
                    ...
                    <!-- Login Form -->
                    <form action="{{ route('mahasiswa.auth-signin-post') }}" method="POST" class="space-y-6">
                        @csrf
