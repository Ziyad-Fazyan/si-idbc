                ...
                <div class="w-full max-w-md mx-auto">
                    <div class="bg-white rounded-xl shadow-lg p-6 sm:p-8 border border-gray-100">
                        ...
                        <div class="mb-6 text-center">
                            <h2 class="text-2xl font-bold text-gray-800">Student Sign In</h2>
                        ...
                        <!-- Login Form -->
                        <form action="{{ route('mahasiswa.auth-signin-post') }}" method="POST" class="space-y-5">
                            @csrf

                            <div>
                                <label for="login" class="block text-sm font-medium text-gray-700 mb-1">Student ID / Email / Phone</label>
                                <div class="relative">
                ...
                <div class="absolute inset-0 flex items-center justify-center p-12">
                    <div class="text-center max-w-lg">
                        <div class="bg-white bg-opacity-10 p-6 rounded-xl backdrop-blur-sm border border-white border-opacity-20 shadow-lg">
                            ...
                            <p class="text-lg text-white">The more effortless the writing looks, the more effort the writer actually put into the process.</p>
                        </div>
                    </div>
                </div>
            </div>
