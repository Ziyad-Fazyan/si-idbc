                ...
                <div class="w-full max-w-md mx-auto">
                    <div class="bg-white rounded-xl shadow-lg p-6 sm:p-8 border border-gray-100">
                        ...
                        <div class="mb-6 text-center">
                            <h2 class="text-2xl font-bold text-gray-800">Lecturer Sign In</h2>
                        ...
                        <!-- Login Form -->
                        <form action="{{ route('dosen.auth-signin-post') }}" method="POST" class="space-y-5">
                            @csrf

                            <div>
                                <label for="login" class="block text-sm font-medium text-gray-700 mb-1">NIDN / Email / Phone</label>
                                <div class="relative">
