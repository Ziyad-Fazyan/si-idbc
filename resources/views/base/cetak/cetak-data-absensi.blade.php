        ...
        <table style="border-collapse: collapse;">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="border: none;">:</td>
                    <td style="text-align: left; border: none;">
                        {{ \Carbon\Carbon::parse($jadkul->start)->format('H:i') . ' - ' . \Carbon\Carbon::parse($jadkul->ended)->format('H:i') }}
                        WIB</td>
                </tr>
                <tr>
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="width: 33%; text-align: left; border: none;">
                        ...
                        <p style="margin-top: 75px;"><b>{{ $jadkul->matkul->pstudi->head->dsn_name }}</b> <br>Kepala
                            Program Studi</p>
                    </td>
                </tr>
