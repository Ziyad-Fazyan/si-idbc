            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="width: 30%; text-align: center; border: none;">
                        <img src="{{ asset('storage') }}/images/website/site-logo.png" alt="Logo" class="logo"
                            style="max-height: 125px; height: auto;">
                    </td>
                    <!-- Kop surat -->
                    <td style="width: 70%; text-align: center; border: none;">
                        <div>
                            ...
                            <p style="margin: 5px 0; font-size: 16px;">Website: www.contoh.ac.id | Email:
                                info@contoh.ac.id</p>
                        </div>
                    </td>
                </tr>
                ...
                <tbody>
                    @forelse ($mahasiswa as $key => $item)
                        <tr>
                            ...
                            <td style="text-align: center" data-label="Jenis Kelamin">
                            ...
                            @php
                                ...
                                // dd($absen->count());
                            @endphp
                            <td style="text-align: center" data-label="Data Kehadiran">{{ $absen->count() }} /
                                {{ $jadkul->count() }} Perkuliahan</td>
                            <td style="text-align: center" data-label="Presentase Kehadiran">
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="width: 33%; text-align: left; border: none;">
                        ...
                        <p style="margin-top: 75px;"><b>{{ $kelas->pstudi->head->dsn_name }}</b> <br>Kepala Program
                            Studi</p>
                    </td>
                </tr>
