...
<body>
    <div class="container my-5 px-5 py-5">
        <div class="row">
            ...
            <div class="col-1 offset-2 logo">
                <img width="125px" height="125px"
                    src="https://siakad-pt.internal-dev.id/storage/images/default/web/site-logo.png" />
            </div>
        ...
        <div class="container-fluid invoice-letter mt-3">
            <div class="row">
                ...
                <div class="col-9 text-white pr-5 py-2 letter-content">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent consequat erat mauris, a
                        scelerisque est pellentesque vel. Proin tempus felis purus, vel molestie nisl condimentum nec.
                        Sed at lorem maximus, venenatis nulla ut, laoreet eros. Etiam et lectus sem. Aenean tempus ante
                        nec lacus aliquet consectetur. Vestibulum sem felis, tempus sit amet libero non, vehicula
                        pellentesque turpis. Suspendisse potenti. </p>
                </div>
            </div>
        </div>
        ...
        <div class="row table mt-5">
            <table class="invoice table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row">3</th>
                        <td class="item">Bootstrap will just take care of this long title. Lorem ipsum dolor sit amet,
                            consectetur adipiscing elit. Ut sit amet tellus lectus. Quisque tincidunt lacus sed turpis
                            blandit rutrum.</td>
                        <td>1</td>
                        <td>25 <span class="currency">&euro;</span> </td>
                        <td>13 %</td>
        ...
        <p class="text-center mt-3"><em>* Taxes will be calculated in &euro; using the default % value for your
                region</em></p>
    </div>
