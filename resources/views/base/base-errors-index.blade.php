        ...
        @if (Str::is('error/verify', request()->path()))
            ...
            <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-lg shadow-lg overflow-hidden mb-6">
                <div class="px-6 py-4 flex justify-between items-center border-b border-yellow-400">
                    ...
                    <a href="{{ url()->current() }}" class="flex items-center px-4 py-2 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full text-white font-medium transition-all duration-200">
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-yellow-100 mt-1">Your account is not yet verified. Please wait for administrator approval or contact support.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-red-100 mt-1">Your account doesn't have permission to access this page. Please return to <a href="/" class="font-bold underline hover:text-white transition-colors">Home</a> or contact your administrator.</p>
                        </div>
                    </div>
                </div>
            </div>
