        ...
        <div id="main" class="min-h-screen flex flex-col">
                                    ...
                                    <x-dropdown hover="true" width="64">
                                        <x-slot name="trigger">
                                            <button
                                                ...
                                                <i class="fas fa-graduation-cap mr-2"></i> Kurikulum <i
                                                    class="fas fa-chevron-down ml-1 text-xs"></i>
                                            </button>
                                        </x-slot>
                                ...
                                <li>
                                    <x-dropdown hover="true" width="64">
                                        <x-slot name="trigger">
                                            <button
                                                class="px-4 py-3 flex items-center text-sm font-medium hover:bg-teal-50 hover:text-teal-800 transition rounded-md text-gray-700">
                                                <i class="fas fa-graduation-cap mr-2"></i> Kompetensi <i
                                                    class="fas fa-chevron-down ml-1 text-xs"></i>
                                            </button>
                                        </x-slot>
            ...
            <footer class="bg-teal-800 text-white py-10 mt-10">
                <div
                    ...
                    <div class="flex flex-col items-start space-y-2">
                        @if (isset($web->school_logo))
                            <img src="{{ asset('storage/images/website/site-logo.png') }}"
                                alt="Logo {{ $web->school_name }}" class="h-12 mb-2">
                        @endif
                    ...
                    <div class="mt-6 md:mt-0">
                        ...
                        <p>{{ $web->school_address ?? 'Jl. Semen Romo Cemani Gg. Melon No.5, Ngruki, Cemani, Kec. Grogol, Kabupaten Sukoharjo, Jawa Tengah 57552' }}
                        </p>
                ...
                <div class="container mx-auto px-4 mt-8 text-center text-teal-200 text-xs">
                    {{ \Carbon\Carbon::now()->translatedFormat('F Y') }} © {{ $web->school_apps }} -
                    {{ $web->school_name }}
                </div>
            </footer>
            ...
            <div class="fixed bottom-3 right-8 z-50 flex gap-4">
                ...
                <a href="{{ route('ppdb.form') }}" title="Pendaftaran Mahasiswa Baru"
                    class="bg-blue-500 hover:bg-blue-600 rounded-full p-4 shadow-lg transition-transform transform hover:scale-110 flex items-center justify-center"
                    style="width: 200px; height: 50px;">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 text-white" viewBox="0 0 576 512"
                        fill="currentColor">
                        <path
