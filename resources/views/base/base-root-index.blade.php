                        ...
                        <div class="header-top-right">
                            ...
                            <div class="dropdown">
                                <a href="#" id="topbarUserDropdown"
                                    ...
                                    @if (Auth::guard('dosen')->check())
                                        ...
                                        <div class="text">
                                            ...
                                            <h6 class="user-dropdown-name">{{ Auth::guard('dosen')->user()->dsn_name }}
                                            </h6>
                                    ...
                                    @elseif(Auth::check())
                                        ...
                                        <div class="text">
                                            ...
                                            <p class="user-dropdown-status text-sm text-muted">{{ Auth::user()->type }}
                                            </p>
                                        </div>
                                    @else
                                        <div class="avatar avatar-md2">
                                        ...
                                        <div class="text">
                                            <h6 class="user-dropdown-name">Silakan Login</h6>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow-lg"
                                    ...
                                    @if (Auth::guard('dosen')->check())
                                        <li><a class="dropdown-item" href="{{ route('dosen.home-profile') }}">My
                                                Account</a>
                                        </li>
                                    ...
                                    @else
                                        <li><a class="dropdown-item"
                                                href="{{ route('mahasiswa.auth-signin-page') }}">Login
                                                Mahasiswa</a></li>
                                        ...
                                        <ul class="submenu-group">
                                            <li class="submenu-item has-sub">
                                                ...
                                                <ul class="subsubmenu">
                                                    ...
                                                    <li class="subsubmenu-item ">
                                                        <a href="#" class="subsubmenu-link">Struktur
                                                            Organisasi</a>
                                                    </li>
                                                    <li class="subsubmenu-item ">
                                            ...
                                            <li class="submenu-item has-sub">
                                                ...
                                                <ul class="subsubmenu">
                                                    @foreach ($proku as $item)
                                                        <li class="subsubmenu-item ">
                                                            <a href="#"
                                                                class="subsubmenu-link">{{ $item->name }}</a>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            </li>
                                            <li class="submenu-item">
                                                <a href="{{ route('root.gallery-index') }}"
                                                    class='submenu-link'>Album Foto</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <li class="submenu-item  has-sub">
                                                    ...
                                                    <ul class="subsubmenu">
                                                        ...
                                                        @foreach ($pstudi as $item)
                                                            <li class="subsubmenu-item ">
                                                                <a href="{{ route('root.home-prodi', $item->slug) }}"
                                                                    class="subsubmenu-link">{{ $item->level . ' - ' . $item->name }}</a>
                                                            </li>
                                                        @endforeach
