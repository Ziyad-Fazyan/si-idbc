                                ...
                                <li>
                                    <x-dropdown hover="true" width="64">
                                        ...
                                        <x-dropdown-section class="py-0.5">
                                            <x-dropdown-link href="{{ route('root.kompetensi-prog') }}"
                                            ...
                                            <x-dropdown-link href="{{ route('root.kompetensi-design') }}"
                                                class="hover:bg-teal-50 border-t border-gray-100">
                                                <div class="flex items-center px-3 py-1.5">
                                        ...
                                        <div x-data="{ open: false }" class="relative">
                                            <button @click="open = !open"
                                                ...
                                                <div class="flex items-center">
                                                    <i
                                                        class="fas fa-laptop-code mr-3 text-teal-600 w-5 text-center"></i>
                                                    Kompetensi
                                                </div>
            ...
            <footer class="bg-teal-800 text-white py-10 mt-10">
                ...
                <div class="fixed bottom-3 right-3 md:right-8 z-50 flex flex-col md:flex-row gap-3 md:gap-4">
                    ...
                    <a href="{{ route('ppdb.form') }}" title="Pendaftaran Mahasiswa Baru"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 md:w-7 md:h-7 text-white"
