        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="dropdown-menu dropdown-menu-xl" aria-labelledby="dropdownMenuButton">
                            ...
                            @foreach ($ticket as $item)
                                <li><a class="dropdown-item"
                                        href="#">{{ '#' . $item->code . ' - ' . $item->subject }}</a></li>
                            @endforeach
                        </ul>
                    </li>
            ...
            <div class="dropdown">
                            ...
                            <div class="avatar avatar-md">
                                @auth('mahasiswa')
                                    <img style="object-fit: cover !important;"
                                        src="{{ asset('storage/images/' . Auth::guard('mahasiswa')->user()->mhs_image) }}">
                                @else
                                    @auth('dosen')
                                        <img
                                            style="object-fit: cover !important; "src="{{ asset('storage/images/' . Auth::guard('dosen')->user()->dsn_image) }}">
                                    @else
                                        @auth
                                            <img
                                                style="object-fit: cover !important; "src="{{ asset('storage/images/' . Auth::user()->image) }}">
                                        @endauth
                                    @endauth
                                @endauth
                            </div>
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"
                    ...
                    @auth
                        <li><a class="dropdown-item" href="{{ route($prefix . 'home-profile') }}"><i
                                    class="icon-mid bi bi-person me-2"></i> My Profile</a></li>
                        <hr class="dropdown-divider">
                        <li><a class="dropdown-item" href="{{ route($prefix . 'auth-signout-post') }}"><i
                                    class="icon-mid bi bi-box-arrow-left me-2"></i> Logout</a></li>
                    @endauth
                    @auth('mahasiswa')
                        <li><a class="dropdown-item" href="{{ route('mahasiswa.home-profile') }}"><i
                                    class="icon-mid bi bi-person me-2"></i> My Profile</a></li>
                        <hr class="dropdown-divider">
                        <li><a class="dropdown-item" href="{{ route('mahasiswa.auth-signout-post') }}"><i
                                    class="icon-mid bi bi-box-arrow-left me-2"></i> Logout</a></li>
                    @endauth
                    @auth('dosen')
                        <li><a class="dropdown-item" href="{{ route('dosen.home-profile') }}"><i
                                    class="icon-mid bi bi-person me-2"></i> My Profile</a></li>
                        <hr class="dropdown-divider">
                        <li><a class="dropdown-item" href="{{ route('dosen.auth-signout-post') }}"><i
                                    class="icon-mid bi bi-box-arrow-left me-2"></i> Logout</a></li>
                    @endauth
                </ul>
            </div>
